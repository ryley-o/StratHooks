...
interface IGenArt721CoreContractV3_Base is IGenArt721CoreProjectScriptV1 {
     ...
     */
    event ArtBlocksCurationRegistryContractUpdated(address indexed artblocksCurationRegistryAddress);
     ...
     */
    event ProjectRoyaltySplitterUpdated(uint256 indexed projectId, address indexed royaltySplitter);
     ...
     */
    function adminACLAllowed(address _sender, address _contract, bytes4 _selector) external returns (bool);
